...
\chapter{Essential stakeholder goals}
...
\subsection{To what extend does the current Blackboard system support the UvA goals?}

\subsubsection{To what extends does the system support the goals of the teachers?}

\subsubsection{To what extends does the system support the goals of the students?}

\subsection{Which type of usability problems have no impact on education?}

\subsection{ What characteristics of users are important to consider for the selection of a new system?}
