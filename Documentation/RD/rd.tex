...
\begin{itemize}                                                           
	...
	\item Important how ICT is used that determines its effectiveness. \todo{If a domain fact is that students use BB because they have to, then a BB-related solution might not be effective. Combine this domain fact with answer to the question. Richard zijn doc zegt dit eigenlijk ook. STudents gebruiken omdat teachers verplicht stellen.}
...
\begin{itemize}
	...
	\item \textbf{The alternative options} identified during elicitation must be c
                                                                                selected on that basis. \todo{Do we have alternative options?}
